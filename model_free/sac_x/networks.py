...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, n_actions, fc1_dims=150, fc2_dims=256, name='critic', chkpt_dir='tmp/sac_x'):
        """
    ...
    def forward(self, state, action):
        ...
        action_value = F.relu(self.fc1(combined))
...
class ValueNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims=150, fc2_dims=256, name='value', chkpt_dir='tmp/sac_x'):
        """
...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, max_action, fc1_dims=150, fc2_dims=256, n_actions=2, name='actor', chkpt_dir='tmp/sac_x'):
        """
