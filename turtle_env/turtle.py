...
class Env(Node):
    ...
    def generate_random_target_position(self):
        ...
        if self.stage == 1:
            ...
            points = [
                (0, 0.8), (0, -0.8), (0.8, -0.8), (-0.8, 0.8), (-0.8, -1.95), (-1.8, -1.95), (-0.8, 1.95), (-1.8, 1.95), (-1.95, -0.8), (1.95, -1.8), (1.5, -1.8), (1.0, -1.8), (-1.5, 1.8), (-1.0, 1.8), (1.95, 1.95), (1.7, 1.95), (1.95, 0.9), (-1.6, 0.4), (1.6, -0.9), (1.6, -1.3), (0.8, 1.95),(-1.95, -1)
            ...
            points = [
                (3.20, 3.20), (2.70, 3.20), (2.20, 3.20), (1.70, 3.20), (1.20, 3.20), (0.70, 3.20), (0.20, 3.20), (-0.30, 3.20), (-0.80, 3.20), (-1.30, 3.20), (-1.80, 3.20), (-2.30, 3.20), (-2.80, 3.20), (3.2, 3.20), (3.2, 2.70), (3.2, 2.20), (3.2, 1.70), (3.2, 1.20), (3.2, 0.70), (3.2, 0.20), (3.2, -0.30), (3.2, -0.80), (3.2, -1.30), (3.2, -1.80), (3.2, -2.30), (3.2, -2.80)
            ]
            chosen_point = random.choice(points)
            self.target_x, self.target_y = chosen_point
