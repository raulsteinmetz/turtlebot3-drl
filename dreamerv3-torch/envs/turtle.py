...
class Env(Node):
    ...
    def generate_random_target_position(self):
        ...
        if self.stage == 1:
            ...
            points = [
                (0, 0.8), (0, -0.8), (0.8, -0.8), (-0.8, 0.8), (-0.8, -1.95), 
                (-1.8, -1.95), (-0.8, 1.95), (-1.8, 1.95), (-1.95, -0.8), 
                (1.95, -1.8), (1.5, -1.8), (1.0, -1.8), (-1.5, 1.8), 
                (-1.0, 1.8), (1.95, 1.95), (1.7, 1.95), (1.95, 0.9), 
                (-1.6, 0.4), (1.6, -0.9), (1.6, -1.3), (0.8, 1.95),(-1.95, -1)         
            ]
            chosen_point = random.choice(points)
            self.target_x, self.target_y = chosen_point
        elif self.stage == 7 or self.stage == 8:
            points = [
                (3.20, 3.20), (2.70, 3.20), (2.20, 3.20), (1.70, 3.20), (1.20, 3.20), 
                (0.70, 3.20), (0.20, 3.20), (-0.30, 3.20), (-0.80, 3.20), (-1.30, 3.20), 
                (-1.80, 3.20), (-2.30, 3.20), (-2.80, 3.20), (3.2, 3.20), (3.2, 2.70), 
                (3.2, 2.20), (3.2, 1.70), (3.2, 1.20), (3.2, 0.70), (3.2, 0.20), 
                (3.2, -0.30), (3.2, -0.80), (3.2, -1.30), (3.2, -1.80), (3.2, -2.30), 
                (3.2, -2.80), (2.5, 2.5), (2.0, 2.5), (1.5, 2.5), (1.0, 2.5), (0.5, 2.5), 
                (0.0, 2.5), (-0.5, 2.5), (-1.0, 2.5), (-1.5, 2.5), (-2.0, 2.5), (2.5, 2.5), 
                (2.5, 2.0), (2.5, 1.5), (2.5, 1.0), (2.5, 0.5), (2.5, 0.0), (2.5, -0.5),
                (2.5, -1.0), (2.5, -1.5), (2.5, -2.0),  (2.0, 2.0), (1.5, 2.0), (1.0, 2.0), 
                (0.5, 2.0), (0.0, 2.0), (-0.5, 2.0), (-1.0, 2.0), (-1.5, 2.0), (2.0, 2.0), 
                (2.0, 1.5), (2.0, 1.0), (2.0, 0.5), (2.0, 0.0), (2.0, -0.5), (2.0, -1.0), (2.0, -1.5),
                # Reused points from stage 5 and 6
                (0, 0.8), (0, -0.8), (0.8, -0.8), (-0.8, 0.8), (-0.8, -1.95), 
                (-1.8, -1.95), (-0.8, 1.95), (-1.8, 1.95), (-1.95, -0.8), 
                (1.95, -1.8), (1.5, -1.8), (1.0, -1.8), (-1.5, 1.8), 
                (-1.0, 1.8), (1.95, 1.95), (1.7, 1.95), (1.95, 0.9), 
            ...
            points = [
                # Center
                (1.5, 1), (1.5, 0), (1.5, -1), (-1.5, 1.3), (-1.5, 0), (-1.5, -1), (-1.5, -2), (0, -2), (1.4, -1),
                # Borders
                (6.5, 3), (6.5, 2), (6.5, 1), (6.5, 0), (6.5, -1), (6.5, -2), (6.5, -3),
                (-6.5, 3), (-6.5, 2), (-6.5, 1), (-6.5, 0), (-6.5, -1), (-6.5, -2), (-6.5, -3),
                (-5.5, 3), (-4.5, 3), (-3.5, 3), (-2.5, 3), (-1.5, 3), (-0.5, 3), (1.5, 3), (2.5, 3), (3.5, 3), (4.5, 3), (5.5, 3), 
                (6.5, 2), (6.5, 2), (6.5, 1), (6.5, 0), (6.5, -1), (6.5, -2), (6.5, -2),
                (-6.5, 2), (-6.5, 2), (-6.5, 1), (-6.5, 0), (-6.5, -1), (-6.5, -2), (-6.5, -2),
                (-5.5, 2), (-4.5, 2), (-2.5, 2), (-2.5, 2), (-1.5, 2), (-0.5, 2), (1.5, 2), (2.5, 2), (2.5, 2), (4.5, 2), (5.5, 2),
                (6.5, 1), (6.5, 1), (6.5, 1), (6.5, 0), (6.5, -1), (6.5, -1), (6.5, -1),
                (-6.5, 1), (-6.5, 1), (-6.5, 1), (-6.5, 0), (-6.5, -1), (-6.5, -1), (-6.5, -1),
                (-5.5, 1), (-4.5, 1), (-1.5, 1), (-1.5, 1), (-1.5, 1), (-0.5, 1), (1.5, 1), (1.5, 1), (1.5, 1), (4.5, 1), (5.5, 1)
            ]
            chosen_point = random.choice(points)
            self.target_x, self.target_y = chosen_point
