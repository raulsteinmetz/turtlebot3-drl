...
class Env(Node):
    ...
    def generate_random_target_position(self):
        ...
        if self.stage == 1:
            ...
            points = [
                (2.0, 1), (2.0, 0.5), (2.0, 0.0), (2.0, -0.5), (2.0, -1.0),
                (1., 2.0), (0.5, 2.0), (0.0, 2.0), (-0.5, 2.0),
                (-0.5, 1.8), (-0.5, 1.6), (1., 1.5), (1., 1.0), (1., 0.5), (1., 0.0),
                (.5, 0.0), (0.0, 0.0), (-0.5, 0.0), (-1., 0.0), (-1.5, 0.0), (-2.0, 0.0),
                (-2.0, 1.0), (-2.0, 0.5), (-2.0, -0.5), (-2.0, -1.0), (-2.0, -1.5), (-2.0, -2.0),
                (-1.5, 0.5), (-1.5, -0.5), (-1.5, -1.0), (-1.5, -1.5), (-1.5, -2.0),
                (-1.0, -0.5), (-1.0, -1.0), (-1.0, -1.5), (-1.0, -2.0),  
                (-0.5, -2.0), (-0., -1.7), (0.5, -1.7), (0.5, -1.4),
                (1.8, 1), (1.8, 0.5), (1.8, 0.0), (1.8, -0.5), (1.8, -1.0), 
                (1.4, 1), (1.4, 0.5), (1.4, 0.0), (1.4, -0.5),
                (1, 1), (1, 0.5), (1, 0.0), (0.5, 0.5), (0.7, 0.7), (0.3, 0.3)
            ]
            chosen_point = random.choice(points)
            self.target_x, self.target_y = chosen_point
        elif self.stage == 5:
